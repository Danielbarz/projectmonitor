    ...
    <header className="w-full h-20 bg-white shadow-sm flex items-center justify-between px-8 sticky top-0 z-40">
      ...
      <div className="flex items-center">
        <h2 className="text-2xl font-['Carlito']">
          ...
          <span className="font-bold text-red-600">User</span>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:block text-left">
              <p className="text-sm font-bold text-slate-800 font-['Carlito']">User Admin</p>
              <p className="text-xs text-slate-500 font-['Carlito']">Administrator</p>
            </div>
