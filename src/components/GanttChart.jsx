    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[400px]">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-40 flex-shrink-0 border-r border-slate-200 bg-white z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] flex flex-col">
           ...
           <div className="flex-1 overflow-y-auto">
              {processedProjects.map((p, i) => (
                 <div key={i} className="h-12 border-b border-slate-100 flex items-center px-4 text-[10px] font-bold text-slate-700 truncate" title={p.order_id}>
                    {p.order_id}
                 </div>
              ))}
           </div>
        ...
        <div className="flex-1 overflow-auto relative">
           <div className={`relative ${viewMode === 'day' ? 'w-[4000px]' : viewMode === 'week' ? 'w-[2000px]' : 'w-full'}`}>
